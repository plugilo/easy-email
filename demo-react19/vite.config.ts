...
export default defineConfig({
  ...
  resolve: {
    alias: {
      '@plugilo/easy-email-editor/lib/style.css': path.resolve(__dirname, 'package.json'), // 没有用的，只是防止css 404报错
      '@plugilo/easy-email-extensions/lib/style.css': path.resolve(
        __dirname,
        'package.json',
      ), // 没有用的，只是防止css 404报错
      ...
      '@plugilo/easy-email-core': path.resolve(
        '../packages/easy-email-core/src/index.tsx',
      ),
      '@plugilo/easy-email-editor/lib/locales.json': path.resolve(
        '../packages/easy-email-editor/public/locales.json',
      ),
      '@plugilo/easy-email-localization': path.resolve(
        '../packages/easy-email-localization',
      ),
      '@plugilo/easy-email-editor': path.resolve(
        '../packages/easy-email-editor/src/index.tsx',
      ),
      '@plugilo/easy-email-extensions': path.resolve(
