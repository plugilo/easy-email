...
export default defineConfig({
  resolve: {
    alias: {
      ...
      '@plugilo/easy-email-core': path.resolve('../packages/easy-email-core'),
      '@plugilo/easy-email-editor': path.resolve('../packages/easy-email-editor'),
      '@plugilo/easy-email-extensions': path.resolve('../packages/easy-email-extensions'),
    },
  },
  optimizeDeps: {},
  define: {},
